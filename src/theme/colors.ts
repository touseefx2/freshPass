export const themes = {
  light: {
    ...
    borderNormal: "#28361833",
    borderMedium: "#2836184D",
    borderDark: "#28361880",
    ...
    // Calendar appointment pastels (soft fills + matching accents)
    apptMintBg: "rgba(96, 108, 56, 0.18)",
    apptMintAccent: "#606C38",
    apptPeachBg: "rgba(221, 161, 94, 0.22)",
    apptPeachAccent: "#BC6C25",
    apptBlueBg: "rgba(54, 90, 184, 0.14)",
    apptBlueAccent: "#365AB8",
    apptPinkBg: "rgba(247, 133, 107, 0.18)",
    apptPinkAccent: "#D45A45",
    apptLavenderBg: "rgba(120, 90, 160, 0.14)",
    apptLavenderAccent: "#6B4F8A",
    apptGoldBg: "rgba(175, 138, 37, 0.16)",
    apptGoldAccent: "#8F7320",
  },
  dark: {},
  blue: {},
};
