...
interface AiHairTryOnConsentModalProps {
  visible: boolean;
  onAgree: () => void;
  onDecline: () => void;
}
...
export default function AiHairTryOnConsentModal({
  visible,
  onAgree,
  onDecline,
    ...
    >
      <View style={styles.modalOverlay}>
        ...
        >
          ...
          <Text style={styles.title}>{t("aiHairTryOnConsentTitle")}</Text>
          ...
          <ScrollView
            ...
            bounces={false}
          >
            <Text style={styles.message}>{t("aiHairTryOnConsentIntro")}</Text>
            <Text style={styles.bulletItem}>
              {t("aiHairTryOnConsentBulletPhoto")}
            </Text>
            <Text style={styles.bulletItem}>
              {t("aiHairTryOnConsentBulletPrompt")}
            </Text>
            <Text style={styles.bulletItem}>
              {t("aiHairTryOnConsentBulletVendor")}
            </Text>
            <Text style={styles.bulletItem}>
              {t("aiHairTryOnConsentBulletRetention")}
            </Text>
            <Text style={styles.bulletItem}>
              {t("aiHairTryOnConsentBulletOptional")}
            </Text>
          </ScrollView>

          <View style={styles.buttonContainer}>
            <Button title={t("aiHairTryOnConsentAgree")} onPress={onAgree} />
          </View>
