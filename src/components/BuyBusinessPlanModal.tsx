...
interface BuyBusinessPlanModalProps {
  visible: boolean;
  onClose: () => void;
  onViewPlans: () => void;
}

export default function BuyBusinessPlanModal({
  visible,
  onClose,
  onViewPlans,
}: BuyBusinessPlanModalProps) {
    ...
    >
      <Pressable style={styles.modalOverlay} onPress={onClose}>
        ...
        >
          ...
          <Text style={styles.title}>{t("pleaseBuyBusinessPlan")}</Text>

          <Text style={styles.subtitle}>
            {t("buyBusinessPlanModalSubtitle")}
          </Text>
          ...
          <View style={styles.buttonContainer}>
            ...
            >
              <Text style={styles.skipButtonText}>{t("notNow")}</Text>
            </TouchableOpacity>
          </View>
        </Pressable>
      </Pressable>
