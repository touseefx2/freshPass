...
interface BusinessPlanPurchasedCongratsModalProps {
  visible: boolean;
  onOk: () => void;
}

export default function BusinessPlanPurchasedCongratsModal({
  visible,
  onOk,
}: BusinessPlanPurchasedCongratsModalProps) {
      ...
      <View style={styles.modalOverlay}>
        ...
        >
          ...
          <Text style={styles.subtitle}>
            {t("businessPlanPurchasedCongratsSubtitle")}
          </Text>

          <Text style={styles.message}>
            {t("businessPlanPurchasedCongratsMessage")}
          </Text>
