...
export default function CancelSubscriptionConfirmModal({
  visible,
  isTrialing,
  endDate,
  onClose,
      ...
      <View style={styles.modalOverlay}>
        ...
        >
          ...
          <Text style={styles.subtitle}>
            {isTrialing
              ? t("cancelTrialConfirm")
              : t("cancelSubscriptionConfirm")}
          </Text>

          <Text style={styles.message}>
            {isTrialing
              ? t("cancelTrialHint", { date: endDate })
              : t("cancelSubscriptionHint", { date: endDate })}
          </Text>

          <View style={styles.buttonContainer}>
            <Button
              title={isTrialing ? t("keepTrial") : t("keepSubscription")}
              onPress={onClose}
            />
            <TouchableOpacity
